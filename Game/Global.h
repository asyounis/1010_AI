...
// Pixel size of the main window
#define WINDOW_WIDTH (500)
#define WINDOW_HEIGHT (500)

// Pixel size of the game board
#define GAME_BOARD_WIDTH (300)
#define GAME_BOARD_HEIGHT (300)

// Pixel size of the pieces
#define PIECES_WIDTH (100)
#define PIECES_HEIGHT (100)
